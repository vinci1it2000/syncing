...
# !/usr/bin/env python
#
# Copyright 2019-2023 European Commission (JRC);
...
__version__ = version = "1.0.8"  # Also update README.rst

# Please UPDATE TIMESTAMP WHEN BUMPING VERSIONS AND BEFORE RELEASE.
#: Release date.
__updated__ = "2023-01-27 18:10:00"
...
__copyright__ = 'Copyright 2019-2023 European Commission (JRC)'
